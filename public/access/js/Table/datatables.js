 ...
 *   https://datatables.net/download/#dt/dt-1.13.1/b-2.3.3/fh-3.3.1/r-2.4.0
 *
 * Included libraries:
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.1/b-2.3.3/fh-3.3.1/r-2.4.0",
	...
	$.extend( DataTable.ext.classes, {
		...
		"sInfo": "pagination__results",
		"sPaging": "pagination_navigation paging_", /* Note that the type is postfixed */
